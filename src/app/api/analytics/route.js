  ...
  try {
    ...
    if (sessionDoc.exists()) {
      ...
      if (event === 'step_completed') {
        if (data.step === 1) updates.completedStep1 = true;
        if (data.step === 2) updates.completedStep2 = true;
        if (data.step === 3) updates.completedStep3 = true;
      }
      if (event === 'step_skipped') {
        if (data.step === 1) updates.skippedStep1 = true;
        if (data.step === 2) updates.skippedStep2 = true;
      }
      ...
      const sessionData = {
        ...
        events: [eventEntry],
        // Funnel flags
        completedStep1: event === 'step_completed' && data.step === 1,
        completedStep2: event === 'step_completed' && data.step === 2,
        completedStep3: event === 'step_completed' && data.step === 3,
        skippedStep1: event === 'step_skipped' && data.step === 1,
        skippedStep2: event === 'step_skipped' && data.step === 2,
